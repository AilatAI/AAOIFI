...
def answer_question(question: str) -> str:
    ...
    system = {
        ...
        "content":(
            ...
            "1. Perform a vector search against the Pinecone index “standards” and retrieve the top 5 most relevant chunks (each chunk has metadata: standard_number, section_number, paragraph_id, _id).\n"
